...
const MAX_LEN = 50000; // קיצוץ ביטחון לטקסטים חריגים בלבד (הנוסח המלא ממילא בקישור).
// היה 6000 בעבר — נמוך מדי: קטע 49 הסברים לגיטימיים-וארוכים באמצע. 50K מכסה
// את כולם, ומשאיר רשת ביטחון מול חילוץ פתולוגי נדיר (חוק-הסדרים ~900K תווים).
